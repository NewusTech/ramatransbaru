...
<div class="container page pb-80">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12">
                    ...
                    <h2 class="title-section"><span>Rama</span> Trans {{ $outlet->parents->nama_provinsi }}</h2>
                    <div class="cws_divider mb-25 mt-5"></div>
                    <p>Rama Trans Travel memiliki alamat kantor yang berada di {{ $outlet->kota_kab }}, {{
                        $outlet->parents->nama_provinsi }}. Lokasinya
                        dapat
                        dilihat melalui google maps dibawah ini.</p>
                    @endforeach
                </div>
            </div>
                    ...
                    <div class="blog-item clearfix boxed" style="max-width: 100%">
                        ...
                        <div class="blog-media">
                            <iframe width="100%" height="230" frameborder="0" scrolling="no" marginheight="0"
                                ...
                                src="https://maps.google.com/maps?q={{ $outlet->lat }},{{ $outlet->lng }}&z=15&output=embed">
                            </iframe>
                        </div>
                        <!-- blog body-->
                        <div class="blog-item-body clearfix">
                            <!-- title-->
                            <h6 class="blog-title">{{ $outlet->kota_kab }}, {{ $outlet->parents->nama_provinsi }}</h6>
                            <div class="blog-item-datas"><strong>Telp: {{ $outlet->phone_1 }} / {{ $outlet->phone_2
                                    }}</strong></div>
                            <!-- Text Intro-->
                            <p>{{ $outlet->alamat }}
                            </p>
