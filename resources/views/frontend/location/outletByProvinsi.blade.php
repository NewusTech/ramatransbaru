...
@section('title', env('APP_NAME', 'Default Name') . ' Lokasi')
@section('content')
    ...
    <div class="container page pb-0 pt-3">
        <div class="row">
                                ...
                                <div class="blog-item clearfix boxed" style="max-width: 100%">
                                    ...
                                    <div class="blog-media">
                                        <iframe width="100%" height="230" frameborder="0" scrolling="no"
                                            marginheight="0" marginwidth="0" style="border:0" allowfullscreen=""
                                            loading="lazy"
                                            src="https://maps.google.com/maps?q={{ $outlet->lat }},{{ $outlet->lng }}&z=15&output=embed">
                                        </iframe>
                                    </div>
                                    <!-- blog body-->
                                    <div class="blog-item-body clearfix mt-3">
                                        <!-- title-->
                                        <h6 class="blog-title">{{ $outlet->kota_kab }},
                                            {{ $outlet->parents->nama_provinsi }}</h6>
                                        <div class="blog-item-datas"><strong>Telp: {{ $outlet->phone_1 }} /
                                                {{ $outlet->phone_2 }}</strong></div>
                                        <!-- Text Intro-->
                                        <p>{{ $outlet->alamat }}
                                        </p>
                                    </div>
                    ...
                    @else
                        <div class="main">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="100%" height="290" viewBox="0 0 470 290">
                                <defs>
                        ...
                        <div class="text-center"
                            ...
                            <div class="recom-price"><span class="font-4"
                                    style="font-weight: 600; text-transform: capitalize">Data tidak
                                    ditemukan!...</span></div>
