...
<div class="content-body">
        ...
        <div class="tp-banner-slider">
            <ul>
                ...
                <li data-masterspeed="700" data-slotamount="7" data-transition="fade"><img
                        src="{{url('frontend-assets/rs-plugin/assets/loader.gif')}}"
                        data-lazyload="{{Storage::url($slider->image)}}">
                    <div class="tp-caption sl-content" data-transform_in="y:-150px;opacity:0;s:1500;e:Power3.easeInOut;"
        ...
        <div class="content-body">
            <div class="container" style="padding-top: 90px padding-bottom: 12px;">
                                        ...
                                        <div class="tours-search">
                                            <div class="col-md-3 col-sm-12 newus-filter-rute">
                                                <div class="selection-box">
                                                    ...
                                                    <select id="asal" name="asal" class="country_to_state country_select">
                                            ...
                                            <button type="submit" class="button-search" style="border: 0">Cari</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="newus-rute-column col-lg-12 col-md-12 col-12">
                        ...
                        <div class="cover-card-rute col-lg-12">
                            ...
                            <div style="padding: 0 0 0 0;" id="newus-card-rute" class="col-md-12">
                                <div class="recom-item border">
                                    ...
                                    <div id="recom-media">
                                        <a href="{{ route('detail-jasa-transportasi.jasaId', $layanans->slug) }}">
                                            <div class="pic">
                                                <img src="{{Storage::url($layanans->image)}}" 
                                                data-at2x="{{Storage::url($layanans->image)}}" alt="">
                                            </div>
                                        </a>
                                    ...
                                    {{-- <div class="recom-media">
                                        <a href="{{ route('detail-jasa-transportasi.jasaId', $layanans->slug) }}" class="goclick">
                                            <div class="pic"><img src="{{Storage::url($layanans->image)}}"
                                                data-at2x="{{Storage::url($layanans->image)}}" alt=""></div>
                                        </a>
                                        <div class="location"><i class="flaticon-suntour-map"></i>&nbsp;{{
                                            $layanans->asal }}
                                        </div>
                                    ...
                                    <div class="recom-item-body">
                                        ...
                                        <a
                                            class="cws-button btn-newus small alt details-button" data-toggle="modal" data-item="{{ $layanans->id }}" data-target="#modalBookingIndex-{{$layanans->id}}">
                                            Pesan
                                        </a>
                                        {{-- <div class="card-body">
                            ...
                            {{-- modal --}}
                            <div class="modal fade" id="modalBookingIndex-{{$layanans->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Booking #{{$layanans->title}}</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" placeholder="Ibrahim" id="namePenumpang-{{$layanans->id}}" class="form-control"/>
                                                </div>
                                                <div class="form-group">
                                                    <label>No. Hp</label>
                                                    <input type="number" placeholder="087987654321" id="no_hp-{{$layanans->id}}" class="form-control newus-form-number"/>
                                                </div>  
                                                <div class="form-group">
                                                    <label>Tanggal</label>
                                                    <input type="date" id="tgl_keberangkatan-{{$layanans->id}}" class="form-control"/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Waktu</label>
                                                    <select id="waktu-{{$layanans->id}}" class="form-control">
                                                ...
                                                <div class="form-group">
                                                    <label>Rute</label>
                                                    <input type="text" id="rute-{{$layanans->id}}" value="{{ $layanans->title }}" readonly class="form-control"/>
                                                    {{-- <select id="rute-{{$layanans->id}}" class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Contoh : 1 Orang" id="tempat_duduk-{{$layanans->id}}" class="form-control"/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Titik Jemput</label>
                                                    <input type="text" id="titik_jemput-{{$layanans->id}}" placeholder="Permata Kost - Jl. Swakarya 1 no. H-28A Rt. 09 RW 02 Dwikora II" class="form-control"/>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="resetBookingIndex()">Close</button>
                                            <button type="button" class="btn btn-success" onclick="formSubmitIndex({{$layanans->id}}, 'https://api.whatsapp.com/send?phone={{ ($layanans && substr($layanans->wa,0,2) == "08") ? "62".substr($layanans->wa,1) : $layanans->wa}}')">Pesan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="text-center">
                    ...
                    <div class="recom-price"><span class="font-4" style="font-weight: 600; text-transform: capitalize">Data
                            tidak ditemukan!...</span>
                    </div>
                    <div class="recom-price"><span class="font-4">Sepertinya belum ada data yang diunggah pada halaman
                            ini.</span>
                    </div>
        ...
        <div class="features-tours-full-width" data-aos="fade-up" data-aos-duration="600">
            <div class=" features-tours-wrap clearfix">
                ...
                <div class="features-tours-item">
                    <div class="features-media"><img class="img-loket" src="{{Storage::url($outlet->image)}}"
                            data-at2x="{{Storage::url($outlet->image)}}" alt>
                        <div class="features-info-top">
                        </div>
                        <div class="features-info-bot">
                            <h4 class="title"><span class="font-4">Lokasi</span> {{ $outlet->nama_provinsi }}</h4><a
                                href="{{ route('locationId',$outlet->slug) }}" class="button">Details</a>
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" data-aos="fade-right" data-aos-duration="500"><img
                        src="{{ Storage::url($tentang->media)}}" data-at2x="{{ Storage::url($tentang->media)}}" alt
                        class="mt-minus-20" style="width: 100%"></div>
                            ...
                            <div class="recom-item border">
                                <div id="recom-media">
                                    <a href="{{ route('layananCategoryId', $layanan->slug) }}">
                                        <div class="pic">
                                            <img src="{{ Storage::url($layanan->media)}}"
                                                data-at2x="{{ Storage::url($layanan->media)}}" alt="">
                                        </div>
                                    </a>
                                </div>
                                <div class="recom-item-body">
                                    ...
                                    <a target="_blank"
                                        ...
                                        class="cws-button box-bottom small alt" target="_blank">Pesan
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="owl-three-item">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-top">
                            <div class="author"> <img src="{{ Storage::url($feedItem->image)}}"
                                    data-at2x="{{ Storage::url($feedItem->image)}}" alt=""
                    ...
                    <div class="swiper mySwiper" style="padding-bottom: 60px">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide" style="width: 300px; height: 300px;">
                                <a href="{{ Storage::url($photo->image)}}" class="fancy">
                                    <div class="portfolio-media"><img src="{{ Storage::url($photo->image)}}"
                                            data-at2x="{{ Storage::url($photo->image)}}" alt>
                                    </div>
                                </a>
                            </div>
                            @endforeach
            ...
            <div class="element-section mb-50 mt-30">
                <div class="row">
                    <div class="col-md-6 mb-md-30">
                        <img src="{{url('frontend-assets/img/faqs.svg')}}" alt="FAQ"
                            data-at2x="{{url('frontend-assets/img/faqs.svg')}}" style="margin-top: -10px" width="85%"
                            height="230px">
                    </div>
                    <div class="col-md-6 mb-md-30">
                        <div class="toggle style-2">
                            @foreach ($faqs as $faq)
                            <div class="content-title @if($loop->first) active @endif"> <span class="active"><i
                                        class="active-icon"></i>{{
                                    $faq->question }}</span>
                            </div>
    ...
    <!-- call out section-->
    <section class="page-section cws_prlx_section bg-white-80 pb-60 pt-60" style="background-color: #1bb583">
        <div class="container">
...
<script>
    ...
    function formSubmitIndex(idForm, sendWa){
        ...
        window.open(sendWa+'&text=Nama%3A%20'+name+'+%20%0ANo.%20hp%3A%20'+noHp+'%20%0ATanggal%20%3A%20'+tglBerangkat+'%20%20%0Awaktu%20%20%3A%20'+waktu+'%20%0ARute%20%3A%20'+rute+'%20%20%0ATempat%20Duduk%3A%20'+tempat_duduk+'%0ATitik%20Jemput%3A%20'+titik_jemput+'')
    }
</script>
