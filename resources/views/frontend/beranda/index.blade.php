                                                    ...
                                                    <a
                                                        ...
                                                        <div class="pic">
                                                            <img src="{{ Storage::url($layanans->image) }}"
                                                                data-at2x="{{ Storage::url($layanans->image) }}"
                                                                alt="">
                                                        </div>
                                                    </a>
                                            ...
                                            $layanans->asal }}
                                                ...
                                                <div class="recom-item-body">
                                                    ...
                                                    <a class="cws-button btn-newus small alt details-button"
                                                        data-toggle="modal" data-item="{{ $layanans->id }}"
                                                        data-target="#modalBookingIndex-{{ $layanans->id }}">
                                                        Pesan
                                                    </a>
                                                    {{-- <div class="card-body">
                        ...
                        <div class="features-tours-item">
                            <div class="features-media"><img class="img-loket" src="{{ Storage::url($outlet->image) }}"
                                ...
                                <div class="features-info-bot">
                                    ...
                                    </h4><a href="{{ route('locationId', $outlet->slug) }}" class="button">Details</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6" data-aos="fade-right" data-aos-duration="500"><img
                            src="{{ Storage::url($tentang->media) }}" data-at2x="{{ Storage::url($tentang->media) }}"
                            alt class="mt-minus-20" style="width: 100%"></div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-md-30">
                            <img src="{{ url('frontend-assets/img/faqs.svg') }}" alt="FAQ"
                                data-at2x="{{ url('frontend-assets/img/faqs.svg') }}" style="margin-top: -10px"
