                    ...
                    <div class="row sm-row">
                        <div class="col-md-6">
                            <div>
                                ...
                                <li>
                                    <a target="_blank" href="https://api.whatsapp.com/send?phone={{ ($contacts && substr($contacts->phone_tr_1,0,2) == '08') ? '62'.substr($contacts->phone_tr_1,1) : $contacts->phone_tr_1}}&text=Hallo%2C%20Saya%20ingin%20memesan%20tiket%20perjalanan%20di%20Rama%20Trans%20Travel.%20Untuk%20pemesanannya%20bagaimana%20ya%3F">{{ $contacts->phone_tr_1 }}</a><br>
                                    @if ($contacts->phone_tr_2 > 0)
                                    <a target="_blank" href="https://api.whatsapp.com/send?phone={{ ($contacts && substr($contacts->phone_tr_2,0,2) == '08') ? '62'.substr($contacts->phone_tr_2,1) : $contacts->phone_tr_2}}&text=Hallo%2C%20Saya%20ingin%20memesan%20tiket%20perjalanan%20di%20Rama%20Trans%20Travel.%20Untuk%20pemesanannya%20bagaimana%20ya%3F">{{ $contacts->phone_tr_2 }}</a>
                                    @else
                                    {{ null }}
                                    @endif
                                </li>
                        ...
                        <div class="col-md-6">
                            <div class="mt-15">
                                ...
                                <li>
                                    <a target="_blank" href="https://api.whatsapp.com/send?phone={{ ($contacts && substr($contacts->phone_cr_1,0,2) == '08') ? '62'.substr($contacts->phone_cr_1,1) : $contacts->phone_cr_1}}&text=Hallo%2C%20Saya%20ingin%20memesan%20tiket%20perjalanan%20di%20Rama%20Trans%20Travel.%20Untuk%20pemesanannya%20bagaimana%20ya%3F">{{ $contacts->phone_cr_1 }}</a><br>
                                    @if ($contacts->phone_cr_2 > 0)
                                    <a target="_blank" href="https://api.whatsapp.com/send?phone={{ ($contacts && substr($contacts->phone_cr_2,0,2) == '08') ? '62'.substr($contacts->phone_cr_2,1) : $contacts->phone_cr_2}}&text=Hallo%2C%20Saya%20ingin%20memesan%20tiket%20perjalanan%20di%20Rama%20Trans%20Travel.%20Untuk%20pemesanannya%20bagaimana%20ya%3F">{{ $contacts->phone_cr_2 }}</a><br>
                                    @else
                                    {{ null }}
                                    @endif
