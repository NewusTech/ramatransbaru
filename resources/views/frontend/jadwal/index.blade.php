                    ...
                    <tbody>
                        @if($rute->count())
                            @foreach($rute as $item)
                                <tr>
                                    <td> {{ $item->asal }} <a href="{{ route('detail-jasa-transportasi.jasaId', $item->slug) }}" class="sm-theme-button sm-hover" title="{{$item->title}}">Lihat &gt;</a></td>
                                    <td> {{ $item->tujuan }} <a href="{{ route('detail-jasa-transportasi.jasaId', $item->slug) }}" class="sm-theme-button sm-hover" title="{{$item->title}}">Lihat &gt;</a></td>
