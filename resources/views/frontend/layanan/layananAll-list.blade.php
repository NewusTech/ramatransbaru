...
<head>
    ...
    <meta name="description"
        content='Rama Tranz Travel adalah Jasa Travel Terbaik dan Ternyaman, Lihat Rute ke {{ $title2 }}'>
    ...
    @foreach ($layanan as $layanans)
        <div class="card" style="width:100%;">
            ...
            <div class="card-body">
                ...
                <a class="theme-button details-button text-white" data-toggle="modal" data-item="{{ $layanans }}"
...
@else
    <div class="main">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="290"
            viewBox="0 0 470 290">
            <defs>
    ...
    <div class="text-center"
        ...
        <div class="recom-price"><span class="font-4" style="font-weight: 600; text-transform: capitalize">Data tidak
                ditemukan!...</span></div>
