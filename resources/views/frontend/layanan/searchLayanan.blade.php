...
@section('content')
    ...
    <section style="background-color:#040b16" class="breadcrumbs">
        <div class="container">
            <div class="text-left breadcrumbs-item"><a href="{{ route('beranda') }}">home</a>
                <i>/</i><a href="javascript:void(0)" class="last"><span>Layanan</span> Transportasi</a>
    ...
    <div class="content-body">
        <div class="container page">
            @if ($layanan->count())
                <div class="row">
                    <div class="newus-rute-column-search col-lg-12 col-md-12 col-12">
                                ...
                                <div style="padding: 0 0 0 0;" id="newus-card-rute" class="col-md-12">
                                    <div class="recom-item border">
                                        ...
                                        <div class="recom-item-body">
                                            ...
                                            {{-- <a
                                    href="https://api.whatsapp.com/send?phone={{ ($layanans && substr($layanans->wa,0,2) == '08') ? '62'.substr($layanans->wa,1) : $layanans->wa}}&text=Hallo%2C%20Saya%20ingin%20memesan%20tiket%20perjalanan%20di%20Rama%20Trans%20Travel.%20Untuk%20pemesanannya%20bagaimana%20ya%3F"
                                    class="cws-button btn-newus small alt" target="_blank">
                                    Pesan
                                </a> --}}
                                            <a class="cws-button btn-newus small alt details-button" data-toggle="modal"
                                                data-item="{{ $layanans->id }}"
                                                ...
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" placeholder="Ibrahim"
                                                            id="namePenumpang-{{ $layanans->id }}" class="form-control" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>No. Hp</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Tanggal</label>
                                                        <input type="date" id="tgl_keberangkatan-{{ $layanans->id }}"
                                                            class="form-control" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Waktu</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="rute-{{ $layanans->id }}"
                                                            value="{{ $layanans->title }}" readonly class="form-control" />
                                                ...
                                                @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" placeholder="Contoh : 1 Orang"
                                                            id="tempat_duduk-{{ $layanans->id }}" class="form-control" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Titik Jemput</label>
                                                        <input type="text" id="titik_jemput-{{ $layanans->id }}"
            ...
            @else
                <div class="main">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="470"
                        height="290" viewBox="0 0 470 290">
                        <defs>
