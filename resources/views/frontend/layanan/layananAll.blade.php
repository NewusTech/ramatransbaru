...
@section('title', 'Harga Tiket Murah dari ' . env('APP_NAME', 'Default Name'))
@section('content')
                            ...
                            <div class="input-group">
                                ...
                                <select id="asal" name="asal" class="form-control">
                                    ...
                                    @foreach ($asals as $item)
                                        ...
                                        <option value="{{ $item }}" {{ $asal == $item ? 'selected' : '' }}>
                                            {{ $item }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="input-group">
                                ...
                                <select id="tujuan" name="tujuan" class="form-control">
                                    ...
                                    @foreach ($tujuans as $item)
                                        {{-- <option value="{{ $item }}">{{ $item }}</option> --}}
                                        <option value="{{ $item }}" {{ $tujuan == $item ? 'selected' : '' }}>
                                            {{ $item }}</option>
                                    @endforeach
                                </select>
                                <div class="input-group-append">
                        ...
                        <div class="col-md-4 col-sm-12 mb-2">
                            <div class="input-group">
                                <select name="jam" id="jam" class="custom-select">
                                    ...
                                    <option value="08.00" {{ $jam == '08.00' ? 'selected' : '' }}>08.00</option>
                                    <option value="12.00" {{ $jam == '12.00' ? 'selected' : '' }}>12.00</option>
                                    <option value="15.00" {{ $jam == '15.00' ? 'selected' : '' }}>15.00</option>
                                    <option value="17.00" {{ $jam == '17.00' ? 'selected' : '' }}>17.00</option>
                                    <option value="19.00" {{ $jam == '19.00' ? 'selected' : '' }}>19.00</option>
                                    <option value="20.00" {{ $jam == '20.00' ? 'selected' : '' }}>20.00</option>
                                </select>
                                <div class="input-group-append">
                                    <button class="btn py-0" type="button"
                                        style="background-color: white; border: 1px solid #ced4da; color: gray"
        ...
        @else
            ...
            <div class="text-center"
                ...
                <div class="recom-price"><span class="font-4">Sepertinya belum ada data yang diunggah pada halaman
                        ini atau coba ganti pencarian.</span></div>
            </div>
